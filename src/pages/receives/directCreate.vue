...
<template>
	<div>
			...
			<div class="content" slot="content">
				<div class="table-content">
					<div class="button-bar">
						...
						<el-button  type="primary" @click="dialogUploadVisible = true">导入</el-button>
					...
					<el-table v-loading="loading" element-loading-text="玩命加载中" :data="tableData"  border style="width:100%" class="el-table_my" @selection-change="handleSelectionChange">
						...
						<el-table-column inline-template :context="_self" label="收货数量" min-width="140">
							<div class="el-input-con">
								<el-input-number v-model="row.receivedCount" placeholder="收货数量" :min="0" :max="9999" @change="handleChangeCount(row)"></el-input-number>
							</div>
						</el-table-column>
						<el-table-column prop="materialUnitName" label="单位" min-width="65"></el-table-column>
						<el-table-column inline-template :context="_self" label="合计(元)" min-width="120">
							<div class="el-input-con">
						...
						<el-table-column inline-template :context="_self" label="是否付款" min-width="100">
							<div class="el-input-con">
								<el-select v-model.number="row.payStatus">
									<el-option
						...
						<el-row type="flex" class="row-bg" justify="space-between">
							...
							<el-col :span="8">
								<div class="grid-content right">
									...
									<el-button type="orange" @click="handleSubmitPO" :loading="user.lock">完成新增</el-button>
								</div>
							</el-col>
						</el-row>
					</div>
		...
		<el-dialog title="导入收货单" v-model="dialogUploadVisible" size="small" class="po-dialog">
			<el-upload
    ...
    export default {
		data() {
			var crumbs = [
			  ...
			  {path:'/receives/direct/create',name: '新增收货单'},
			];
			var tableData =[{
                "materialId":"",
                "materialName": "",
		...
		methods: {
            ...
            loadAll() {//获取所有物料，采购员和供应商列表
                ...
                this.$http({
                    ...
                    if (data.code == 200) {
                        ...
                        this.batchPurchasers=this.batchPurchasers.concat([{purchaserId:"0",purchaserName:"系统采购员"}]);
            ...
            handleSubmitPO(){
	            ...
	            /*奇葩的验证 end*/
                let requestData = {};
                let requestUrl = '/pms/receipt/detail/receipt.do';
                let retMsg = '直接添加收货单成功';
                ...
                this.$http({
                    ...
                    if (data.code == 200) {
                        ...
                        this.$router.push('/receives/direct');
                    }else{
                        this.$message({
                            message: data.message,
                            type: 'warning'
