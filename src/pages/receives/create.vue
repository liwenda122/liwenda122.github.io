	...
	<div>
		<common-layout :crumbs=crumbs>
			<div class="content" slot="content">
				<div class="table-content">
					<div class="order-bar">
						<el-row>
							<el-col :span="12"><div class="grid-content left">收货</div></el-col>
							<el-col :span="12">
					...
					<div class="button-bar">
						...
						<el-table v-loading="loading" element-loading-text="玩命加载中" :data="tableData"  border style="width:100%" class="el-table_my" @selection-change="handleSelectionChange">
							...
							<el-table-column inline-template :context="_self" label="采购数量" min-width="95" >
								<div class="el-input-con">
							...
							<el-table-column inline-template :context="_self" label="合计(元)" min-width="110">
								<div class="el-input-con">
						...
						<el-row type="flex" class="row-bg" justify="space-between">
							...
							<el-col :span="8">
								<div class="grid-content right">
									...
									<el-button type="orange" @click="handleSubmitPO" :loading="user.lock">确认收货</el-button>
								</div>
							</el-col>
						</el-row>
					</div>
		...
		<el-dialog title="批量编辑" v-model="dialogVisible" size="small" class="po-dialog">
			...
			<div slot="footer" class="dialog-footer">
				...
				<el-button type="orange" @click="handleConfirmDialog">保存</el-button>
			</div>
		</el-dialog>
...
<script>
    ...
    export default {
		data() {
			var crumbs = [
			  {path:'/',name: '首页'},
			  {path:'/receives',name: '根据采购单收货'},
			  {path:'/receives/create',name: '收货'},
			];
			var tableData =[];
			var orderData ={};
			var materials = [];
