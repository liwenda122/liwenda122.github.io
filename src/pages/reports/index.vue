			...
			<div class="content" slot="content">
				...
				<div class="table-content">
					...
					<el-table v-loading="loading" element-loading-text="玩命加载中" :data="list" height="442" border style="width:100%">
						...
						<el-table-column prop="payment" label="采购金额" min-width="100" inline-template>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handleExport(){
                utils.export('/pms/report/purchase/export.do',{"filter":this.formSearch.purchaseno,"startTime":this.formSearch.date.length >0 && this.formSearch.date[0]?moment(this.formSearch.date[0]).format('YYYY-MM-DD'):'',"endTime":this.formSearch.date.length >1 && this.formSearch.date[1]?moment(this.formSearch.date[1]).format('YYYY-MM-DD'):''})
            }
        },
        created(){
            this.refresh()
