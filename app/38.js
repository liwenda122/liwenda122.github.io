	...
	exports.default = {
	    data: function data() {
	        return {
	            ...
	            rules: { //验证规则
	                materialTypeName: [{ required: true, message: '请输入类别名称', trigger: 'blur' }],
	                materialTypeShortName: [{ required: true, message: '请输入类别简拼', trigger: 'blur' }]
	            }
	        };
	    },
	    ...
	    watch: {
	        /*简拼*/
	        "form.materialTypeName": function formMaterialTypeName(word) {
	            var materialTypeShortName = '';
	    ...
	    methods: {
	            ...
	            this.$refs.form.validate(function (valid) {
	                if (valid) {
	                    if (materialId) {
	                        ...
	                        utils.post(urls.materialTypeEdit, _this.form, _this).then(function (data) {
	                            if (data.code == 200) {
	                                this.$message({
	                                    message: '修改操作成功',
	                                    type: 'success'
	                        ...
	                        /*新增类别*/
	                        utils.post(urls.materialTypeAdd, _this.form, _this).then(function (data) {
	                            if (data.code == 200) {
	                                this.$message({
	                                    message: '添加操作成功',
	                                    type: 'success'
	        ...
	        showInfo: function showInfo() {
	            var requestData = { "materialTypeId": this.$route.query.materialTypeId };
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('el-dialog', {
	    ...
	    model: {
	      value: (_vm.form.materialTypeName),
	      callback: function($$v) {
	        _vm.form.materialTypeName = (typeof $$v === 'string' ? $$v.trim() : $$v)
	      },
	      expression: "form.materialTypeName"
	    }
	    ...
	    model: {
	      value: (_vm.form.materialTypeShortName),
	      callback: function($$v) {
	        _vm.form.materialTypeShortName = (typeof $$v === 'string' ? $$v.trim() : $$v)
	      },
	      expression: "form.materialTypeShortName"
	    }
	  })], 1)], 1), _vm._v(" "), _c('el-col', {
	    attrs: {
	      "span": 24
	  ...
	  }, [_vm._v("取消")]), _vm._v(" "), (_vm.title == '修改类别') ? _c('el-button', {
	    attrs: {
	      "type": "primary"
	    },
	    on: {
	  ...
	  }, [_vm._v("保存")]) : _vm._e(), _vm._v(" "), (_vm.title == '新增类别') ? _c('el-button', {
	    attrs: {
	      "type": "primary"
	    },
	    on: {
