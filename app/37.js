...
/***/ (function(module, exports, __webpack_require__) {
	...
	var update = __webpack_require__(432)("786438e0", content, true);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".paddingLeft[data-v-150e4409]{padding-left:10px;padding-top:6px}.btncon_right[data-v-150e4409]{padding-top:200px;float:right}.w100[data-v-150e4409]{width:100%}", ""]);
	    ...
	    data: function data() {
	        return {
	            ...
	            rules: { //验证规则
	                ...
	                materialShortName: [{ required: true, message: '请输入物料简拼', trigger: 'blur' }],
	                materialTypeId: [{ required: true, message: '请选择物料类别', trigger: 'change,blur' }],
	                materialUnitId: [{ required: true, message: '请选择物料单位', trigger: 'change,blur' }]
	            }
	        };
	    },
	        ...
	        onSubmit: function onSubmit(ifContinue, materialId) {
	            ...
	            this.$refs.form.validate(function (valid) {
	                if (valid) {
	                    if (materialId) {
	                        /*修改物料*/
	                        _this.form.materialId = _this.$route.query.materialId;
	                        utils.post(urls.materialEdit, _this.form, _this).then(function (data) {
	                            if (data.code == 200) {
	                                this.$message({
	                                    message: '修改操作成功',
	                                    type: 'success'
	                        ...
	                        /*新增物料*/
	                        utils.post(urls.materialAdd, _this.form, _this).then(function (data) {
	                            if (data.code == 200) {
	                                this.$message({
	                                    message: '添加操作成功',
	                                    type: 'success'
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('el-dialog', {
	    ...
	    model: {
	      ...
	      callback: function($$v) {
	        _vm.form.materialName = (typeof $$v === 'string' ? $$v.trim() : $$v)
	      },
	    ...
	    model: {
	      ...
	      callback: function($$v) {
	        _vm.form.materialShortName = (typeof $$v === 'string' ? $$v.trim() : $$v)
	      },
	  ...
	  }, [_vm._v("取消")]), _vm._v(" "), (_vm.title == '查看物料') ? _c('el-button', {
	    attrs: {
	      "type": "primary"
	    },
	    on: {
	  ...
	  }, [_vm._v("修改")]) : _vm._e(), _vm._v(" "), (_vm.title == '修改物料') ? _c('el-button', {
	    attrs: {
	      "type": "primary"
	    },
	    on: {
	  ...
	  }, [_vm._v("保存")]) : _vm._e(), _vm._v(" "), (_vm.title == '新增物料') ? _c('el-button', {
	    attrs: {
	      "type": "primary"
	    },
	    on: {
	  ...
	  }, [_vm._v("保存并新增")]) : _vm._e(), _vm._v(" "), (_vm.title == '新增物料') ? _c('el-button', {
	    attrs: {
	      "type": "primary"
	    },
	    on: {
	  ...
	  }, [_vm._v("完成")]) : _vm._e()], 1)], 1)], 1)], 1), _vm._v(" "), _c('transition', {
	    on: {
	      "leave": _vm.refresh
	    }
	  }, [_c('router-view')], 1)], 1)
