	...
	exports.default = {
	    data: function data() {
	        return {
	            ...
	            rules: { //验证规则
	                materialUnitName: [{ required: true, message: '请输入单位名称', trigger: 'blur' }],
	                materialUnitShortName: [{ required: true, message: '请输入单位简拼', trigger: 'blur' }]
	            }
	        };
	    },
	    ...
	    watch: {
	        /*简拼*/
	        "form.materialUnitName": function formMaterialUnitName(word) {
	            var materialUnitShortName = '';
	    ...
	    methods: {
	        ...
	        onSubmit: function onSubmit(materialId) {
	            var _this = this;
	            ...
	            this.$refs.form.validate(function (valid) {
	                if (valid) {
	                    if (materialId) {
	                        ...
	                        utils.post(urls.materialUnitEdit, _this.form, _this).then(function (data) {
	                            if (data.code == 200) {
	                                this.$message({
	                                    message: '修改操作成功',
	                                    type: 'success'
	                        ...
	                        /*新增单位*/
	                        utils.post(urls.materialUnitAdd, _this.form, _this).then(function (data) {
	                            if (data.code == 200) {
	                                this.$message({
	                                    message: '添加操作成功',
	                                    type: 'success'
	        ...
	        showInfo: function showInfo() {
	            var requestData = { "materialUnitId": this.$route.query.materialUnitId };
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('el-dialog', {
	    ...
	    model: {
	      value: (_vm.form.materialUnitName),
	      callback: function($$v) {
	        _vm.form.materialUnitName = (typeof $$v === 'string' ? $$v.trim() : $$v)
	      },
	      expression: "form.materialUnitName"
	    }
	    ...
	    model: {
	      value: (_vm.form.materialUnitShortName),
	      callback: function($$v) {
	        _vm.form.materialUnitShortName = (typeof $$v === 'string' ? $$v.trim() : $$v)
	      },
	      expression: "form.materialUnitShortName"
	    }
	  })], 1)], 1), _vm._v(" "), _c('el-col', {
	    attrs: {
	      "span": 24
	  ...
	  }, [_vm._v("取消")]), _vm._v(" "), (_vm.title == '修改单位') ? _c('el-button', {
	    attrs: {
	      "type": "primary"
	    },
	    on: {
	  ...
	  }, [_vm._v("保存")]) : _vm._e(), _vm._v(" "), (_vm.title == '新增单位') ? _c('el-button', {
	    attrs: {
	      "type": "primary"
	    },
	    on: {
